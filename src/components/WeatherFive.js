      ...
      <div className="container-fluid">
        <div className="row justify-content-center">
          <div className="col-md-2">
            ...
            { this.props.fiveDays && <h6 className="five-temp"><span className="high-low-fahr">{ this.props.fiveDays[0].Temperature.Minimum.Value } &deg;F</span> <span className="high-low-celsius">{ this.fahrenheitToCelsius(this.props.fiveDays[0].Temperature.Minimum.Value) } &deg;C</span></h6> }
          </div>
          <div className="col-md-2">
            ...
            { this.props.fiveDays && <h6 className="five-temp"><span className="high-low-fahr">{ this.props.fiveDays[1].Temperature.Minimum.Value } &deg;F</span> <span className="high-low-celsius">{ this.fahrenheitToCelsius(this.props.fiveDays[1].Temperature.Minimum.Value) } &deg;C</span></h6> }
          </div>
          <div className="col-md-2">
            ...
            { this.props.fiveDays && <h6 className="five-temp"><span className="high-low-fahr">{ this.props.fiveDays[2].Temperature.Minimum.Value } &deg;F</span> <span className="high-low-celsius">{ this.fahrenheitToCelsius(this.props.fiveDays[2].Temperature.Minimum.Value) } &deg;C</span></h6> }
          </div>
          <div className="col-md-2">
            ...
            { this.props.fiveDays && <h6 className="five-temp"><span className="high-low-fahr">{ this.props.fiveDays[3].Temperature.Minimum.Value } &deg;F</span> <span className="high-low-celsius">{ this.fahrenheitToCelsius(this.props.fiveDays[3].Temperature.Minimum.Value) } &deg;C</span></h6> }
          </div>
          <div className="col-md-2">
            ...
            { this.props.fiveDays && <h6 className="five-temp"><span className="high-low-fahr">{ this.props.fiveDays[4].Temperature.Minimum.Value } &deg;F</span> <span className="high-low-celsius">{ this.fahrenheitToCelsius(this.props.fiveDays[4].Temperature.Minimum.Value) } &deg;C</span></h6> }
          </div>
        </div>
      </div>
    );
